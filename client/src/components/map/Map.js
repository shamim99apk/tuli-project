...
Geocode.setApiKey("AIzaSyDF_gJZjHUVLbC4-Gai_gJBksbINlyRNNI");
Geocode.enableDebug();
  ...
  render() {
    ...
    return (
      <div style={{ padding: "1rem", margin: "0 auto", maxWidth: 1000 }}>
        ...
        <AsyncMap
          googleMapURL='https://maps.googleapis.com/maps/api/js?key=AIzaSyDF_gJZjHUVLbC4-Gai_gJBksbINlyRNNI&libraries=places'
          loadingElement={<div style={{ height: `100%` }} />}
